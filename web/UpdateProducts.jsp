<%-- 
    ...
    Created on : Oct 26, 2024, 10:54:31 PM
    Author     : HP
--%>
                ...
                <form action="ProductController" class="mid-block">
                    ...
                    <div class="row mid_align">
                        <div class="col-lg-8 col-md-6">
                            <h6 class="checkout__title">Update Products</h6>
                            <div class="checkout__input">
                                <p>ProductID<span>*</span></p>
                                <input type="text" value="<%=pro.getProductID()%>" name="ProductID" readonly> 
                            </div>
                            <div class="checkout__input">
                                
                                <p>ProductName<span>*</span></p>
                                <input type="text" class="checkout__input__add" value="<%=pro.getProductName()%>" name="ProductName"> 
                            </div>
                            <div class="checkout__input">
                                
                                <p>Price<span>*</span></p>
                                <input type="text" value="<%=pro.getPrice()%>" name="Price"> 
                            </div>
                            <div class="checkout__input">
                                
                                <p>Stock<span>*</span></p>
                                <input type="text" value="<%=pro.getStock()%>" name="Stock"> 
                            </div>
                            <div class="checkout__input">
                                
                                <p>CategoryID<span>*</span></p>
                                <input type="text" value="<%=pro.getCategoryID()%>" name="CategoryID"> 
                            </div>
                            <div class="checkout__input">
                                
                                <p>Description<span>*</span></p>
                                <input type="text" value="<%=pro.getDescription()%>" name="Description"> 
                            </div>
                            <div class="checkout__input">
                                
                                <p>ImageURL<span>*</span></p>
                                <input type="text" value="<%=pro.getImageURL()%>" name="ImageURL"> 
                            </div>
                        </div>
                    </div>
