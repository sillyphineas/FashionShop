<%-- 
    ...
    Created on : Oct 23, 2024, 10:40:38 PM
    Author     : HP
--%>
...
<body>
    ...
    <%
        Vector<Users> userList = (Vector<Users>) request.getAttribute("userList");
    %>
                  ...
                  <div class="table-responsive bg-white">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th scope="row" style="color: #666666;"><%=userList.get(i).getUserID()%></th>
                          <td><%=userList.get(i).getUsername()%></td>
                          <td><%=userList.get(i).getPassword()%></td>
                          <td><%=userList.get(i).getRoleID()%></td>
                          <td><a class="underline_text" href="UsersController?service=updateUser&UserID=<%=userList.get(i).getUserID()%>" class="text_hover">Update</a></td>
                          <td><a class="underline_text" href="UsersController?service=deleteUser&UserID=<%=userList.get(i).getUserID()%>" class="text_hover">Delete</a></td>
                        </tr>
                        <%}%>
                      </tbody>
                    </table>
                    ...
                    <div class="row row1">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="continue__btn update__btn">
                                <a href="HomePageAdmin.jsp">Back to Home</a>
                            </div>
                        </div>
                    </div>
            </div>     
