<%-- 
    ...
    Created on : Oct 20, 2024, 12:48:47 AM
    Author     : HP
--%>
    ...
    <head>
        ...
        <style>
            .product__cart__item__pic img {
                width: 100px; /* Thiết lập chiều rộng */
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <%
                            double totalPrice = 0;
                            for (int i = 0; i < cart.getItemsList().size(); i++) {
                                totalPrice += Math.round(cart.getItemsList().get(i).getQuantity() * cart.getItemsList().get(i).getProduct().getPrice() * 100.0) / 100.0;
                            }
                        %>
