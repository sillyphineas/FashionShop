<%-- 
    ...
    Created on : Oct 24, 2024, 9:31:38 AM
    Author     : HP
--%>
    ...
    <section class="checkout spad">
        <div class="container">
            <div class="checkout__form">
                <form action="UsersController" class="mid-block">
                    <input type="hidden" name="service" value="updateUser">
                    <div class="row mid_align">
                        <div class="col-lg-8 col-md-6">
                            <h6 class="checkout__title">Update Users</h6>
                            <div class="checkout__input">
                                <p>UserId<span>*</span></p>
                                <input type="text" value="<%=user.getUserID()%>" name="UserId" readonly> 
                            </div>
                            <div class="checkout__input">
                                
                                <p>Username<span>*</span></p>
                                <input type="text" class="checkout__input__add" value="<%=user.getUsername()%>" name="Username"> 
                            </div>
                            <div class="checkout__input">
                            ...
                            <div class="checkout__input">
                                ...
                                <p>RoleId<span>*</span></p>
                                <input type="text" value="<%=user.getRoleID()%>" name="RoleId"> 
                            </div>
                        </div>
                    </div>
