<%-- 
    Document   : Checkout
    Created on : Oct 20, 2024, 12:46:40 AM
    Author     : HP
--%>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-6">
                                ...
                                <div class="checkout__input">
                                    ...
                                    <input type="text" placeholder="House Number, District, City,..." class="checkout__input__add" name="address" required>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="checkout__input">
                                ...
                                <div class="checkout__order">
                                    ...
                                    <ul class="checkout__total__products">
                                        <%for (int i = 0; i < cart.getItemsList().size(); i++) {%>
                                            <li> <%=cart.getItemsList().get(i).getProduct().getProductName()%> <span>$<%=Math.round(cart.getItemsList().get(i).getQuantity() * cart.getItemsList().get(i).getProduct().getPrice() * 100.0) / 100.0%></span></li>
                                        <%}%>
                                    </ul>
